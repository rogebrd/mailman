...
export const Register = ({email, setEmail, onSubmit}) => {
    return (
        <div className="email-input-wrapper">
            ...
            <input className="email-input" type="text" placeholder="Email Address" value={email} onChange={(change) => setEmail(change.target.value)}></input>
            <button className="email-input-button" onClick={onSubmit}>Sign up</button>
        </div>
