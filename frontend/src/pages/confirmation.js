    ...
    return (
        <div className="home">
            ...
            <div className="content-single content">
                ...
                <h1 className="no-padding single-title title">Check your email to begin</h1>
                <p className="single-title page-subtitle">Send any email to save it and any attachments</p>
